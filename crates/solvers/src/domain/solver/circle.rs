//! "Circle" solver implementation.
//!
//! The circle solver is a simple solver implementation that finds the best
//! path of excess trades in an orderbook over a set coincidances of wants.
//!
use {
    crate::{
        boundary,
    ...
    pub async fn solve(&self, auction: auction::Auction) -> Vec<solution::Solution> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            groups
                ...
                .enumerate()
                .filter_map(|(i, group)| {
                    boundary::circle::solve(&group.orders, group.liquidity).map(|solution| {
